...
contract GetAmountsForLiquidity {
    function testAmountsForPriceInside() public pure {
        ...
        (uint256 amount0, uint256 amount1) =
            LiquidityAmounts.getAmountsForLiquidity(sqrtPriceX96, sqrtPriceAX96, sqrtPriceBX96, 2148);
        require(amount0 == 99);
        require(amount1 == 99);
    }
    ...
    function testAmountsForPriceBelow() public pure {
        ...
        uint160 sqrtPriceBX96 = encodePriceSqrt(110, 100);
        (uint256 amount0, uint256 amount1) =
            LiquidityAmounts.getAmountsForLiquidity(sqrtPriceX96, sqrtPriceAX96, sqrtPriceBX96, 1048);
        require(amount0 == 99);
        require(amount1 == 0);
    }
    ...
    function testAmountsForPriceAbove() public pure {
        ...
        uint160 sqrtPriceBX96 = encodePriceSqrt(110, 100);
        (uint256 amount0, uint256 amount1) =
            LiquidityAmounts.getAmountsForLiquidity(sqrtPriceX96, sqrtPriceAX96, sqrtPriceBX96, 2097);
        require(amount0 == 0);
        require(amount1 == 199);
    }
